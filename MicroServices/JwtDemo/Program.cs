...
namespace JwtDemo
{
    ...
    */
    ...
    {
        private static string GetTolen()
        {
        ...
        private static void Main(string[] args)
        {
            ...
            string token = GetTolen();
            token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJVc2VySWQiOjEyMywiVXNlck5hbWUiOiJhZG1pbiIsImV4cCI6MTUyODEwNzgxOX0.pGYSOMzBqROH1NfrLq6bcL0GmW4tsrSlxoFKQKQnd1Y";
